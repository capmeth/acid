...
export default
{
    ...
    'config.parsers.*.use.0': test.functionOrString,
    ...
    'config.toAssetId.*': test.unset,
    'config.toAssetId.0': test.regexOrArrayOrString,
    'config.toAssetId.1': test.functionOrString,
    'config.toAssetName': test.functionOrArrayOrStringOrNull,
    'config.toAssetName.*': test.unset,
    'config.toAssetName.0': test.regexOrArrayOrString,
    'config.toAssetName.1': test.functionOrString,
    ...
    'config.updateMarkdown.*<plain>.replace': test.functionOrString,
